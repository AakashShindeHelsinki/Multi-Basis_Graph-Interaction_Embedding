...
def data_prep(data = 'classification',features = 30, n_samples = 10):
    ...
    if data == 'classification':
        X, y = make_classification(n_samples=n_samples, n_features=features, n_classes=2, class_sep=3, n_informative=10, n_redundant=20, n_clusters_per_class=1, random_state=42)
    elif data == 'synthetic':
