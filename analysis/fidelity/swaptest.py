...
def data_prep(data = 'classification',features = 30, n_samples = 10):
    ...
    if data == 'classification':
        X, y = make_classification(n_samples=n_samples, n_features=features, n_classes=2, class_sep=3.0, n_informative=30, n_repeated= 0 ,n_redundant=0, n_clusters_per_class=1, random_state=42)
        X = normalize(X)
